...
from tensorflow.compat.v1.data.experimental import prefetch_to_device, shuffle_and_repeat, map_and_batch
...
class UGATIT(object) :
    ...
    def train(self):
        ...
        for epoch in range(start_epoch, self.epoch):
            ...
            print('\nEpoch {}/{}'.format((epoch+1), self.epoch))
            progbar = tf.keras.utils.Progbar(self.iteration)
